...
const EditUser = (props) => {
  ...
  var { username, mail_address, has_admin } = location.state;

  var [updatedUsername, setUpdatedUsername] = useState(""),
      [updatedMailAddress, setUpdatedMailAddress] = useState(mail_address),
          ...
          <form>
            <div className="form-group">
              ...
              <textarea
                ...
                onBlur={(e) => {
                  setUpdatedMailAddress(e.target.value);
                }}
              >
                {mail_address}
              </textarea>
        ...
        <Card.Footer>
          ...
          <Button
            ...
            onClick={(e) => {
              ...
              if (
                updatedUsername == "" &&
                updatedMailAddress == mail_address &&
                admin == has_admin
              ) {
                noChangeEvent();
                return;
